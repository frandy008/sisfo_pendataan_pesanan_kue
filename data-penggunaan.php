                ...
                <div class="col-lg-12">
                  <div class="card mb-0">
                    <div class="card-header">
                      <h3 class="h4 mb-0">Penggunaan Bahan</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <table class="table mb-0">
                          <thead>
                            <tr>
                              ...
                              $bb = mysqli_query($conn,"SELECT * FROM tbl_bahan_baku ORDER BY nama_bahan_baku ASC");
                              while ($b = mysqli_fetch_assoc($bb)) { ?>
                              <th><?php echo $b['nama_bahan_baku'] ?></th>
                              <?php } ?>
                              <th></th>
                            </tr>
                          </thead>
                          <tbody id="data">
                            ...
                            <tr>
                              ...
                              $bb = mysqli_query($conn,"SELECT * FROM tbl_bahan_baku ORDER BY nama_bahan_baku ASC");
                              while ($b = mysqli_fetch_assoc($bb)) { 
                              $sj = mysqli_fetch_assoc(mysqli_query($conn,"SELECT * FROM tbl_penggunaan WHERE kode_pesanan = '$d[kode_pesanan]' AND kode_bahan_baku = '$b[kode_bahan_baku]'"));
                              ?>
                              <td align="center"><?php echo $sj['jumlah'] ?></td>
                              <?php } ?>
                              <td>
                                <button class="btn btn-danger btn-hapus" data-btn="penggunaan" data-id="<?php echo $d['kode_pesanan'] ?>">Hapus</button>
                              </td>
                            </tr>
                            <?php } ?>
                          </tbody>
