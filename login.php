              ...
              <div class="col-lg-6">
                <div class="info d-flex justify-content-center flex-column p-4 h-100">
                  <div class="py-5">
                    ...
                    <p class="fw-light mb-0">Silahkan login untuk menggunakan aplikasi</p>
                  </div>
                </div>
              </div>
              <!-- Form Panel    -->
              <div class="col-lg-6 bg-white">
                <div class="d-flex align-items-center px-4 px-lg-5 h-100">
                  <form class="login-form py-5 w-100">
                    ...
                    <button class="btn btn-primary mb-3" id="login" type="button">Login</button><br>
                    <a class="text-sm text-paleBlue" href="#" hidden="">Forgot Password?</a><br>
                    <small class="text-gray-500" hidden="">Do not have an account? </small>
                    <a class="text-sm text-paleBlue" href="register.html" hidden="">Signup</a>
                  </form>
                </div>
              </div>
            </div>
